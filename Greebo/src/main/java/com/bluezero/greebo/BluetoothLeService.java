...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED = "com.bluezero.greebo.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.bluezero.greebo.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.bluezero.greebo.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE = "com.bluezero.greebo.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA = "com.bluezero.greebo.EXTRA_DATA";
    ...
    public boolean connect(final String address) {
        ...
        // parameter to false.
        _bluetoothGatt = device.connectGatt(this, false, mGattCallback);
